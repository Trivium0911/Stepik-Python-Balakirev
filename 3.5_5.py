"""
                        3.5 Сравнения __eq__, __ne__, __lt__, __gt__ и другие 5
...
sym = '–?!,.; '
lst_text = [StringText(i.strip(sym) for i in line.split() if len(i.strip(sym)) > 0) for line in stich]
lst_text_sorted = sorted(lst_text, reverse=True)
lst_text_sorted = [" ".join(x.lst) for x in lst_text_sorted]
