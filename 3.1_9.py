"""
                    3.1 Методы __setattr__, __getattribute__, __getattr__ и __delattr__ 9
...
class Dimensions:
    ...
    @classmethod
    def __check_val(cls, val):
        return type(val) in (int, float) and cls.MIN_DIMENSION <= val <= cls.MAX_DIMENSION
