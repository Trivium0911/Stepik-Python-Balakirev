"""
                            4.4 Наследование. Атрибуты private и protected  10
...
сделать, чтобы не создавался объект самого класса, а лишь возвращался объект или класса WindowsFileDialog,
...
class FileDialogFactory:
    def __new__(cls, *args):
        return {'windows': cls.create_windows_filedialog(*args),
                'linux': cls.create_linux_filedialog(*args)}[CURRENT_OS]
