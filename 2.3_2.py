"""
                            2.3 Дескрипторы (data descriptor и non-data descriptor) 2
...
validate() проверяться корректность присваиваемых данных. Если данные некорректны,
...
class ValidateString:
    ...
    def validate(self, string):
        return type(string) is str and self.min_length <= string <= self.max_length
