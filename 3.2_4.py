"""
                                            3.2 Метод __call__. Функторы и классы-декораторы 4
...
post параметр request - это словарь с ключами 'login' и 'password'
...
class CharsValidator:
    ...
    def __call__(self, strin, *args, **kwargs):
        res = []
        for i in strin:
            res.append(i in self.chars)
        return all(res)
...
lv = LengthValidator(3, 50) # min_length - минимально допустимая длина; max_length - максимально допустимая длина
