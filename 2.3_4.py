"""
                         2.3 Дескрипторы (data descriptor и non-data descriptor) 4
...
где название - наименование предмета (строка); вес - вес предмета (вещественное число).
...
class Bag:
    ...
    def remove_thing(self, indx):
        self.__things.remove(self.__things[indx])
